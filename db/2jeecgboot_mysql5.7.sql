...
CREATE TABLE `onl_cgform_field`  (
  ...
  `db_is_key` tinyint NULL DEFAULT NULL COMMENT '是否主键 0否 1是',
  `db_is_null` tinyint NULL DEFAULT NULL COMMENT '是否允许为空0否 1是',
  ...
  `is_query` tinyint NULL DEFAULT NULL COMMENT '是否查询条件0否 1是',
  `is_show_form` tinyint NULL DEFAULT NULL COMMENT '表单是否显示0否 1是',
  `is_show_list` tinyint NULL DEFAULT NULL COMMENT '列表是否显示0否 1是',
  `is_read_only` tinyint NULL DEFAULT 0 COMMENT '是否是只读（1是 0否）',
...
CREATE TABLE `sys_permission`  (
  ...
  `always_show` tinyint NULL DEFAULT NULL COMMENT '聚合子路由: 1是0否',
  `icon` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单图标',
  `is_route` tinyint NULL DEFAULT 1 COMMENT '是否路由菜单: 0:不是  1:是（默认值1）',
  `is_leaf` tinyint NULL DEFAULT NULL COMMENT '是否叶子节点:    1:是   0:不是',
  `keep_alive` tinyint NULL DEFAULT NULL COMMENT '是否缓存该页面:    1:是   0:不是',
  ...
  `internal_or_external` tinyint NULL DEFAULT NULL COMMENT '外链菜单打开方式 0/内部打开 1/外部打开',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sys_user`  (
  ...
  `sex` tinyint NULL DEFAULT NULL COMMENT '性别(0-默认未知,1-男,2-女)',
  ...
  `status` tinyint NULL DEFAULT NULL COMMENT '性别(1-正常,2-冻结)',
  `del_flag` tinyint NULL DEFAULT NULL COMMENT '删除状态(0-正常,1-已删除)',
  `activiti_sync` tinyint NULL DEFAULT NULL COMMENT '同步工作流引擎(1-同步,0-不同步)',
  ...
  `update_by` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `identity` tinyint NULL DEFAULT NULL COMMENT '身份（1普通成员 2上级）',
