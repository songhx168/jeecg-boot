package org.jeecg.modules.assetretirementnew.entity;
 ...
 */
@Data
@TableName("asset_retirement_new")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="asset_retirement_new对象", description="资产清理表单")
public class AssetRetirementNew implements Serializable {
