...
@Data
@TableName("asset_retirement_detail")
public class AssetRetirementDetail implements Serializable {
	...
	/**资产清理表主键*/
	@ApiModelProperty(value = "资产清理表主键")
	private java.lang.String assetRetirementId;
}
